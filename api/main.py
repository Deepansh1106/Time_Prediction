...
with open("/Users/deepansh/Desktop/FDTP ML Project1/models/delivery_time_model.pkl", "rb") as f:
    model = pickle.load(f)

with open("/Users/deepansh/Desktop/FDTP ML Project1/models/scaler.pkl", "rb") as f:
